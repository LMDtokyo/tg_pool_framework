...
public partial class SmsPoolView : UserControl
{
    public SmsPoolView(SmsPoolViewModel viewModel)
        : this((HeroSmsViewModel)viewModel)
    {
    }

    protected SmsPoolView(HeroSmsViewModel viewModel)
    {
        InitializeComponent();
