...
/// <summary>
/// Typed HttpClient wrapper for the control API (tg_pool/api/app.py).
...
public sealed class BackendClient
{
    ...
    /// gate (tg_pool/api/license_gate.py) picks up the activation. Never throws
        ...
        CancellationToken ct = default)
    {
        ...
        return await resp.Content.ReadFromJsonAsync<DatamollPurchaseDto>(ct)
            ?? throw new InvalidOperationException("Andromeda service returned an empty order response");
    }
