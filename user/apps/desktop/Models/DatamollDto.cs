...
public static class DatamollMoney
{
...
public sealed class DatamollProductDto
{
    ...
    [JsonIgnore]
    public string PriceDisplay => $"{Currency} {DatamollMoney.Format(Price)}";
...
public sealed class DatamollPurchaseRequest : PaymentApiKeyRequest
{
    [JsonPropertyName("product_id")]
    public int ProductId { get; init; }
...
public partial class DatamollActivityRow : ObservableObject
{
    ...
    [ObservableProperty]
    private string message = "Submitting order to Andromeda service...";
