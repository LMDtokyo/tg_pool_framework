...
tg_pool.features.* напрямую, без этого меню). Без TTY и без MODE — понятная
...
_MODES = {
    "send": ("Рассылка сообщений", "tg_pool.features.messaging"),
    "parse": ("Сбор пользователей (парсинг)", "tg_pool.features.parsing"),
    "check_accounts": ("Проверка аккаунтов", "tg_pool.features.account_check"),
    "check_proxies": ("Проверка прокси", "tg_pool.features.proxy_check"),
    "convert_tdata": ("Конвертация tdata в session", "tg_pool.features.tdata_convert"),
    "convert_session": ("Конвертация session в tdata", "tg_pool.features.session_convert"),
}
