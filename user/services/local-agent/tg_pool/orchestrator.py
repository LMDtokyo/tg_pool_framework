...
from tg_pool.accounts.connection_manager import ClientFactory, ClientPool
...
from tg_pool.extraction.entity_resolver import describe_entity, estimate_entity_weight
...
from tg_pool.messaging.messaging_service import BatchReport, MessagePayload, send_notifications

if TYPE_CHECKING:
    from tg_pool.accounts.account_registry import AccountRegistry
    from tg_pool.accounts.warmup_policy import WarmupPolicy
    from tg_pool.extraction.data_extraction import LuaStrategySelector
