"""
tg_pool/messaging/auto_responder.py — Lua-driven auto-reply to inbound messages.
...
same script contract as LuaScriptFilter (tg_pool/extraction/user_filter.py):
`return function(...) ... end`.
