"""
tg_pool/data_extraction.py — Data Extraction Module.
...
простаивает — см. orchestrate_extraction_only() в tg_pool/orchestrator.py.
...
from tg_pool.extraction.entity_resolver import EntityKind, UniversalEntityResolver
...
class LuaStrategySelector:
    ...
    "supergroup", "channel", "unknown"; see tg_pool.extraction.entity_resolver.EntityKind).
    ...
    pipeline -- same principle as LuaScriptFilter (tg_pool/extraction/user_filter.py).
    """
