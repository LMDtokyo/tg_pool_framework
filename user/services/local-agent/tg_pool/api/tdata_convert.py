"""
tg_pool/api/tdata_convert.py — Background tdata-conversion job lifecycle.

Same shape as ProxyCheckManager (tg_pool/api/proxy_check.py): a single in-flight
...
from tg_pool.proxy.tdata_converter import ConversionResult, TDataConverter, find_tdata_folders
