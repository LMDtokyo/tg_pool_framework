"""
tg_pool/features/proxy_check.py — Standalone proxy-list health/speed check (MODE=check_proxies).

Reads a JSON proxy list (PROXY_LIST_JSON), checks every proxy concurrently
against a real Telegram DC (tg_pool.proxy.proxy_checker.check_all_proxies),
...
from tg_pool.proxy.proxy_list import load_proxies_from_json
