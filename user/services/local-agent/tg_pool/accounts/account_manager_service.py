"""
tg_pool/accounts/account_manager_service.py — AccountManagerService facade.
...
from tg_pool.accounts.health_checker import AccountStatus, HealthChecker, PoolHealthReport
from tg_pool.config import normalize_account_phone
