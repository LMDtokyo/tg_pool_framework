"""
tg_pool/accounts/periodic_health_scheduler.py — Recurring full-pool health recheck.

CooldownScheduler (tg_pool/accounts/cooldown_scheduler.py) only rechecks accounts
