"""
tg_pool/accounts/proxy_safety.py — Guards against silently routing risky bulk
...
across many accounts (ProxyAllocator's round-robin, tg_pool/accounts/account_loader.py)
