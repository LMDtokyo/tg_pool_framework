"""
tg_pool/connection_manager.py — Proxy & Connection Manager.
...
class ClientFactory:
    ...
    Почему класс со static method вместо обычной функции?
      1. Удобнее мокировать в тестах: mock.patch('tg_pool.accounts.connection_manager.ClientFactory.build').
