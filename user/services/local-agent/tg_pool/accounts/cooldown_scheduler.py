"""
tg_pool/accounts/cooldown_scheduler.py — Auto-returns cooled-down accounts to the pool.

AccountState.restriction_expires (tg_pool/health_checker.py) and
AccountQuery.filter_restriction_expiring_within() (tg_pool/account_registry.py) already
