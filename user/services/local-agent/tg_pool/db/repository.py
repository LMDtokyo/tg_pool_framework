"""
tg_pool/db/repository.py — AccountRepository: the only place ORM details are visible.
...
from tg_pool.db.models import AccountRow
...
class AccountRepository:
    ...
    async def load_all(self) -> List["RegistryEntry"]:
        ...
        from tg_pool.accounts.account_registry import RegistryEntry  # local import: avoid circular import
