"""
tg_pool/licensing/service.py — Local license gate.
...
from tg_pool.db.license_repository import LicenseStateRepository, StoredLicenseState
from tg_pool.licensing.client import LicenseError, LicenseServerClient, LicenseServerUnavailableError
