"""tests/test_events.py — tg_pool/api/events.py's WS event forwarding allowlist."""

from __future__ import annotations

import pytest

from tg_pool.api.events import _FORWARDED_EVENTS, _serialize
from tg_pool.monitoring.event_bus import AccountsDiscoveredEvent
