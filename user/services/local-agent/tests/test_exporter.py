"""
tests/test_exporter.py — Unit tests for tg_pool/exporter.py.
...
from tg_pool.extraction.exporter import DataExporter, LuaColumnHook, _COLUMNS
...
# ---------------------------------------------------------------------------
# stats() — end-of-run report breakdown (tg_pool.api.parsing._write_report)
# ---------------------------------------------------------------------------
