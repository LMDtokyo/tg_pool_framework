"""tests/test_forward_source.py — tg_pool/messaging/forward_source.py."""
...
from tg_pool.messaging.forward_source import parse_message_link, resolve_forward_source
