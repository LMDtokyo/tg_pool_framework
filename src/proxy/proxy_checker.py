"""
src/proxy_checker.py — Async proxy health checker.
...
Usage:
    from src.proxy.proxy_checker import check_proxy, ProxyType, ProxyState
...
from src.proxy.proxy_geo import country_for_proxy_host
...
async def check_account_proxies(
    ...
    **check_proxy_kwargs: Any,
    ...
    """
    Checks the proxy attached to each account (src.config.AccountConfig) --
