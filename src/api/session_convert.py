"""
src/api/session_convert.py — Background session->tdata job lifecycle.

Same shape as TdataConvertManager (src/api/tdata_convert.py): a single
...
from src.proxy.tdata_converter import ConversionResult, TDataConverter
