...
;   2. Installs the Python backend SOURCE (src\, main.py, requirements.txt,
...
;      at runtime -- see launcher/TgPoolLauncher/Services/AppPaths.cs.
...
;   1. dotnet publish launcher\TgPoolLauncher -c Release -p:PublishProfile=win-x64
;   2. iscc installer\TgPoolLauncher.iss
;   Output: installer\Output\TelegramAndromedaSetup-<version>.exe
;
...
#define RepoRoot "..\"
#define PublishDir "..\launcher\TgPoolLauncher\bin\Release\net10.0-windows\win-x64\publish"
...
; profile -- see launcher/TgPoolLauncher/Properties/PublishProfiles/win-x64.pubxml).
Source: "{#PublishDir}\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion

; Python backend source -- the launcher spawns `python -m uvicorn src.api.app:app`
...
Source: "{#RepoRoot}src\*"; DestDir: "{app}\src"; Flags: ignoreversion recursesubdirs createallsubdirs; Excludes: "__pycache__,*.pyc"
Source: "{#RepoRoot}main.py"; DestDir: "{app}"; Flags: ignoreversion
