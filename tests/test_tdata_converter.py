"""
tests/test_tdata_converter.py — Unit tests for src/tdata_converter.py.
...
from src.proxy.tdata_converter import (
    ConversionResult,
...
class TestTdataToSession:
    @patch("src.proxy.tdata_converter.TDesktop")
...
class TestSessionToTdata:
    @patch("src.proxy.tdata_converter.OpenteleClient")
...
class TestBatchTdata:
    @patch("src.proxy.tdata_converter.asyncio.sleep", new_callable=AsyncMock)
