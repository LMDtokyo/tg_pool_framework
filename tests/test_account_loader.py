"""
tests/test_account_loader.py — Tests for src/account_loader.py.
...
from src.accounts.account_loader import (
    ProxyAllocator,
...
# ---------------------------------------------------------------------------
# load_from_tdata — delegates to TDataConverter (src/proxy/tdata_converter.py)
# ---------------------------------------------------------------------------
...
class TestLoadFromTdata:
    ...
    async def test_raises_import_error_when_opentele_unavailable(self, tmp_path, monkeypatch):
        import src.accounts.account_loader as al
    ...
    async def test_conversion_error_propagates(self, tmp_path):
        from src.proxy.tdata_converter import TDataInvalidError
